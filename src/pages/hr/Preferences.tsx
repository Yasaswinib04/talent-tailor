...
export function HRPreferences() {
  return (
    ...
    >
      <div>
        <h2 className="text-4xl font-black tracking-tighter uppercase italic">Preferences</h2>
        <p className="text-muted-foreground mt-2 font-mono text-sm tracking-wide">Configure protocols and rubrics.</p>
      </div>
